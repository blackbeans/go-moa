...
func (mj *MoaRawReqPacket) MarshalJSON() ([]byte, error) {
...
func (mj *MoaRawReqPacket) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	if mj == nil {
		buf.WriteString("null")
		return nil
	}
	...
	/* Inline struct. type=struct { Method string "json:\"m\""; Args []json.RawMessage "json:\"args\"" } kind=struct */
...
const (
	ffj_t_MoaRawReqPacketbase = iota
	ffj_t_MoaRawReqPacketno_such_key

	ffj_t_MoaRawReqPacket_ServiceUri

	ffj_t_MoaRawReqPacket_Params
)

var ffj_key_MoaRawReqPacket_ServiceUri = []byte("action")

var ffj_key_MoaRawReqPacket_Params = []byte("params")

func (uj *MoaRawReqPacket) UnmarshalJSON(input []byte) error {
	fs := fflib.NewFFLexer(input)
	return uj.UnmarshalJSONFFLexer(fs, fflib.FFParse_map_start)
}

func (uj *MoaRawReqPacket) UnmarshalJSONFFLexer(fs *fflib.FFLexer, state fflib.FFParseState) error {
	var err error = nil
	currentKey := ffj_t_MoaRawReqPacketbase
	_ = currentKey
...
mainparse:
	for {
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				// "" case. hrm.
				currentKey = ffj_t_MoaRawReqPacketno_such_key
				...
				case 'a':
					...
					if bytes.Equal(ffj_key_MoaRawReqPacket_ServiceUri, kn) {
						currentKey = ffj_t_MoaRawReqPacket_ServiceUri
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'p':
					...
					if bytes.Equal(ffj_key_MoaRawReqPacket_Params, kn) {
						currentKey = ffj_t_MoaRawReqPacket_Params
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.EqualFoldRight(ffj_key_MoaRawReqPacket_Params, kn) {
					currentKey = ffj_t_MoaRawReqPacket_Params
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.SimpleLetterEqualFold(ffj_key_MoaRawReqPacket_ServiceUri, kn) {
					currentKey = ffj_t_MoaRawReqPacket_ServiceUri
					state = fflib.FFParse_want_colon
					goto mainparse
				}
		...
		case fflib.FFParse_want_value:
			...
			if tok == fflib.FFTok_left_brace || tok == fflib.FFTok_left_bracket || tok == fflib.FFTok_integer || tok == fflib.FFTok_double || tok == fflib.FFTok_string || tok == fflib.FFTok_bool || tok == fflib.FFTok_null {
				...
				case ffj_t_MoaRawReqPacket_ServiceUri:
					goto handle_ServiceUri

				case ffj_t_MoaRawReqPacket_Params:
					goto handle_Params

				case ffj_t_MoaRawReqPacketno_such_key:
...
handle_Params:
	...
	/* handler: uj.Params type=struct { Method string "json:\"m\""; Args []json.RawMessage "json:\"args\"" } kind=struct quoted=false*/

	{
		/* Falling back. type=struct { Method string "json:\"m\""; Args []json.RawMessage "json:\"args\"" } kind=struct */
...
func (mj *MoaRawRespPacket) MarshalJSON() ([]byte, error) {
	var buf fflib.Buffer
	if mj == nil {
		buf.WriteString("null")
		return buf.Bytes(), nil
...
func (mj *MoaRawRespPacket) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	if mj == nil {
		buf.WriteString("null")
		return nil
	}
...
const (
	ffj_t_MoaRawRespPacketbase = iota
	ffj_t_MoaRawRespPacketno_such_key

	ffj_t_MoaRawRespPacket_ErrCode

	ffj_t_MoaRawRespPacket_Message

	ffj_t_MoaRawRespPacket_Result
)

var ffj_key_MoaRawRespPacket_ErrCode = []byte("ec")

var ffj_key_MoaRawRespPacket_Message = []byte("em")

var ffj_key_MoaRawRespPacket_Result = []byte("result")

func (uj *MoaRawRespPacket) UnmarshalJSON(input []byte) error {
	fs := fflib.NewFFLexer(input)
	return uj.UnmarshalJSONFFLexer(fs, fflib.FFParse_map_start)
}

func (uj *MoaRawRespPacket) UnmarshalJSONFFLexer(fs *fflib.FFLexer, state fflib.FFParseState) error {
	var err error = nil
	currentKey := ffj_t_MoaRawRespPacketbase
	_ = currentKey
	tok := fflib.FFTok_init
	wantedTok := fflib.FFTok_init
...
mainparse:
	for {
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				// "" case. hrm.
				currentKey = ffj_t_MoaRawRespPacketno_such_key
				state = fflib.FFParse_want_colon
				goto mainparse
			} else {
				switch kn[0] {
				...
				case 'e':
					...
					if bytes.Equal(ffj_key_MoaRawRespPacket_ErrCode, kn) {
						currentKey = ffj_t_MoaRawRespPacket_ErrCode
						state = fflib.FFParse_want_colon
						goto mainparse

					} else if bytes.Equal(ffj_key_MoaRawRespPacket_Message, kn) {
						currentKey = ffj_t_MoaRawRespPacket_Message
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'r':
					...
					if bytes.Equal(ffj_key_MoaRawRespPacket_Result, kn) {
						currentKey = ffj_t_MoaRawRespPacket_Result
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.EqualFoldRight(ffj_key_MoaRawRespPacket_Result, kn) {
					currentKey = ffj_t_MoaRawRespPacket_Result
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.SimpleLetterEqualFold(ffj_key_MoaRawRespPacket_Message, kn) {
					currentKey = ffj_t_MoaRawRespPacket_Message
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.SimpleLetterEqualFold(ffj_key_MoaRawRespPacket_ErrCode, kn) {
					currentKey = ffj_t_MoaRawRespPacket_ErrCode
					state = fflib.FFParse_want_colon
					goto mainparse
				}
		...
		case fflib.FFParse_want_value:
			...
			if tok == fflib.FFTok_left_brace || tok == fflib.FFTok_left_bracket || tok == fflib.FFTok_integer || tok == fflib.FFTok_double || tok == fflib.FFTok_string || tok == fflib.FFTok_bool || tok == fflib.FFTok_null {
				...
				case ffj_t_MoaRawRespPacket_ErrCode:
					goto handle_ErrCode

				case ffj_t_MoaRawRespPacket_Message:
					goto handle_Message

				case ffj_t_MoaRawRespPacket_Result:
					goto handle_Result

				case ffj_t_MoaRawRespPacketno_such_key:
					err = fs.SkipField(tok)
					if err != nil {
						return fs.WrapErr(err)
					}
...
var ffj_key_MoaReqPacket_Params = []byte("params")
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				...
				case 'p':
					...
					if bytes.Equal(ffj_key_MoaReqPacket_Params, kn) {
